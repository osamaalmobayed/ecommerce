 ...
 <option value="{{ $subsub->id }}" {{ $subsub->id == $products->subsubcategory_id ? 'selected': '' }} >{{ $subsub->subsubcategory_name_en }}</option>	
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Name Ger <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			<h5>Product Tags Ger <span class="text-danger">*</span></h5>
			<div class="controls">
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Size Ger <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Product Color Ger <span class="text-danger">*</span></h5>
			<div class="controls">
