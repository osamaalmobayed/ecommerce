...
@if(session()->get('language') == 'hindi') My Account @else My Account @endif
            </a></li>
...
@if(session()->get('language') == 'hindi') Deutsch @else Language @endif
  </span><b class="caret"></b></a>
              <ul class="dropdown-menu">
         @if(session()->get('language') == 'hindi')       
        <li><a href="{{ route('english.language') }}">English</a></li>
        @else
        <li><a href="{{ route('hindi.language') }}">Deutsch</a></li>
         @endif      
              </ul>
            </li>
          </ul>
...
@if(session()->get('language') == 'hindi') Home @else Home @endif
  </a> </li>
